...
include('../../config/config.php');
    ...
    if(isset($_POST['themsanpham'])){
        $sql_them = "INSERT INTO tbl_sanpham(ten_sanpham, ma_sanpham, gia_sanpham, soluong_sanpham, hinhanh_sanpham, tomtat_sanpham, noidung_sanpham, tinhtrang_sanpham, id_danhmuc) VALUE ('".$tensanpham."','".$masanpham."','".$giasanpham."','".$soluong."','".$hinhanh."','".$tomtat."','".$noidung."','".$tinhtrang."','".$danhmuc."')";
        ...
        if($hinhanh!=''){
            ...
            , tinhtrang_sanpham = '".$tinhtrang."', id_danhmuc = '".$danhmuc."' WHERE id_sanpham = '$_GET[id_sanpham]'";
